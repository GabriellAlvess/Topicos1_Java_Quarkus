...
public class UsuarioResourceTest {
    ...
    public void testInsert() {
        UsuarioDTO dto = new UsuarioDTO("Roberta Maria", "roberta", "123",
                "roberta@email.com", 1, "123.456.789-09", Arrays.asList(new TelefoneDTO("63", "987654321")));
    ...
    public void testUpdate() {
        UsuarioDTO dto = new UsuarioDTO("Joao Silva", "joao123", "123",
                "joao@email.com", 1, "123.456.789-00", Arrays.asList(new TelefoneDTO("62", "888888888")));
